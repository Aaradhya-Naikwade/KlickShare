...
// import connectMongo from "@/lib/mongodb";
// import Group from "@/models/Group";
// import User from "@/models/User"; // ✅ THIS FIXES IT
...
//     // --------------------------------------------------
//     // FORWARD EACH FILE TO PYTHON FACE SERVICE
//     // --------------------------------------------------
//     for (const file of files) {
//       if (!file || !file.name) continue;
...
//       const res = await fetch(`${PYTHON_API}/add-face`, {
//         method: "POST",
//         body: fd,
//       });
...
//       if (!res.ok) {
//         throw new Error(data?.detail || "Python upload failed");
//       }
...
//         user: mid,
//         title: `New photos in "${group.name}"`,
//         body: `${uploadedUrls.length} new photo(s) were added to the group.`,
...
//     return NextResponse.json(
//       { message: "Files uploaded", files: uploadedUrls },
//       { status: 200 }
//     );
//   } catch (err: any) {
//     console.error("UPLOAD ERROR:", err);
